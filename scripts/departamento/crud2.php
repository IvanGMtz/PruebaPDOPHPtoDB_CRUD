<?php
    ...
    class crud2 extends connect{
        ...
        public function postAll(){
            $res =$this->con->prepare("INSERT INTO departamento(nombreDep, idPais) VALUES(:nom, :idp)");
        ...
        public function putAll(){
            $res = $this->con->prepare("UPDATE departamento SET nombreDep = :nom, idPais=:idp WHERE idDep = :id");
